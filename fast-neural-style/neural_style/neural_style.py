...
def stylize(args,filename):
    print("transfer...")
    print(filename)
    content_image = utils.tensor_load_rgbimage(args, None,None)
    content_image = content_image.unsqueeze(0)
    outpath = '../../data/transfered/'
    out = os.path.join(outpath,filename)
    # if args.cuda:
    model = '../saved-models/starry-night.pth'
    mask_path = '../../data/mask/'
    mask_image_path = os.path.join(mask_path,filename)
    ...
    # print(output.data[0])
    img = utils.tensor_save_bgrimage(output.data[0], out, 1)
